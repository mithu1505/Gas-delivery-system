...
{
private:
    Node_12_5* head12; Node_12_5* tail12;
    Node_5* head5; Node_5* tail5;
...
public:
    ...
    Node_12_5* gethead12() { return head12; }
    Node_12_5* gettail12() { return tail12; }
    Node_5* gethead5() { return head5; }
    Node_5* gettail5() { return tail5; }

    void retailer_menu()//Menu that the retailer use
    {
        //To clear screen before displaying the following menu
        char choice;
        do
        {
            ...
            case '5':
                ...
                cout << "\n\t12.5KG Litro\t\t\t" << inStock12_5 - size12 << endl;
                cout << "\t5.0KG Litro\t\t\t" << inStock5 - size5 << endl;
            case '6':
                break;
            default:
                cout << "\n\t\t\======== Invalid input ========";
    ...
    void insert_Customer()//Insertion of a customers detail
    {
        ...
        if (type == "12.5")
        {
            ...
            {
                Node_12_5* NewCustomer = new Node_12_5;
                NewCustomer->name = name;
                NewCustomer->ic_num = NIC;
                Node_12_5* current = head12;
        ...
        else if (type == "5")
        {
            if (size5 < inStock5)
            {
                Node_5* NewCustomer = new Node_5;
                NewCustomer->name = name;
                NewCustomer->ic_num = NIC;
                Node_5* current = head5;
                bool isavalable = false;
    ...
    void Booking_detail()
    {
        ...
        cin >> ic; cout << endl;
        Node_12_5* current12 = head12;
        bool isAvailable12 = false;
        Node_5* current5 = head5;
        ...
        if (isAvailable12 == false || isAvailable5 == false)
        {
    ...
    void customerMenu()
    {
        ...
        do
        {
            ...
            case '1':
            {
                ...
                cout << "\n\t12.5KG Litro\t\t" << inStock12_5 - size12 << "\t\t" << pri12 << endl;
                cout << "\t5.0KG Litro\t\t" << inStock5 - size5 << "\t\t" << pri5 << endl;
...
int main()
{
    ...
    {
        system("cls");
        cout << "\n\n\n\t\t______________QUEUE BOOKING SYSTEM______________" << endl;
        cout << "\n\n\tNo        Functions                       Description" << endl;
